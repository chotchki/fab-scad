...
- **K harness: use/include/scope differential tests vs the OpenSCAD oracle** — added 2026-07-05.
- **Eval-model: top-level variables are whole-scope / last-assignment-wins (OpenSCAD), not sequential** — added 2026-07-05.
