...
- [ ] AH.2 - divergence burn-down: first census = 60/94 matched, 34 diverged — 5 feature-pending, 1 harness-mode, 1 PRNG, the rest REAL parity bugs in ~10 root-cause clusters eval-clean never saw:
  ...
  - [ ] AH.2.4 - positional-after-named binding: `f(a=1,2)` → [1, 2, "c"] (positional fills the next UNNAMED slot), ours [2, "b", "c"] — arg-permutations line 12
  ...
  - [ ] AH.2.10 - $preview: seed it (false for real render; the Files lane seeds true — upstream's echo tests run preview-mode) — preview_variable.scad
