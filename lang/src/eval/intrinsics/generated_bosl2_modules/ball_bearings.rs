...
pub(super) fn ball_bearing(fx: &dyn rt::ModuleCtx) -> rt::Result<rt::Geo> {
 ...
 Ok(fx.group(parts)) }, ]) })?);
    for l13_i in rt::iter_values_warned(fx, &rt::build_range(&rt::Value::Num(f64::from_bits(0x0_u64)), &rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64)), &rt::binary(fx, rt::BinOp::Sub, l12_ball_cnt.clone(), rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64))))) {
