...
pub(super) fn _fab_poc_band2(fx: &dyn rt::FnCtx, args: &[rt::Value]) -> rt::Result<rt::Value> {
    ...
    let out = { let l0_n = rt::index(p_v.clone(), &p_i.clone()); { if !(rt::bi::is_num(&[l0_n.clone()])).is_truthy() { return Err(rt::assert_failed(None, "is_num(n)")); } rt::apply_binary(rt::BinOp::Mul, l0_n.clone(), rt::Value::Num(f64::from_bits(0x4000000000000000_u64))) } };
    Ok(out)
}
...
pub(super) fn posmod(fx: &dyn rt::FnCtx, args: &[rt::Value]) -> rt::Result<rt::Value> {
    ...
    let out = { if !(rt::Value::Bool(rt::Value::Bool(is_finite(fx, &[p_x.clone()])?.is_truthy() && is_finite(fx, &[p_m.clone()])?.is_truthy()).is_truthy() && rt::apply_unary(rt::UnOp::Not, approx(fx, &[p_m.clone(), rt::Value::Num(f64::from_bits(0x0_u64))])?).is_truthy())).is_truthy() { return Err(rt::assert_failed(Some(&rt::Value::string("\nInput must be finite numbers. The divisor cannot be zero.")), "((is_finite(x) && is_finite(m)) && (!approx(m, 0)))")); } rt::apply_binary(rt::BinOp::Mod, rt::apply_binary(rt::BinOp::Add, rt::apply_binary(rt::BinOp::Mod, p_x.clone(), p_m.clone()), p_m.clone()), p_m.clone()) };
    Ok(out)
}
...
pub(super) fn idx(fx: &dyn rt::FnCtx, args: &[rt::Value]) -> rt::Result<rt::Value> {
    ...
    let out = { if !(rt::Value::Bool(rt::bi::is_list(&[p_list.clone()]).is_truthy() || rt::bi::is_string(&[p_list.clone()]).is_truthy())).is_truthy() { return Err(rt::assert_failed(Some(&rt::Value::string("Invalid input.")), "(is_list(list) || is_string(list))")); } { let l0_ll = rt::bi::len(&[p_list.clone()]); if rt::apply_binary(rt::BinOp::Eq, l0_ll.clone(), rt::Value::Num(f64::from_bits(0x0_u64))).is_truthy() { rt::build_range(&rt::Value::Num(f64::from_bits(0x0_u64)), &rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64)), &rt::apply_binary(rt::BinOp::Sub, l0_ll.clone(), rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64)))) } else { { let l1_s = posmod(fx, &[p_s.clone(), l0_ll.clone()])?; let l2_e = posmod(fx, &[p_e.clone(), l0_ll.clone()])?; rt::build_range(&l1_s.clone(), &p_step.clone(), &l2_e.clone()) } } } };
    Ok(out)
}
...
pub(super) fn same_shape(fx: &dyn rt::FnCtx, args: &[rt::Value]) -> rt::Result<rt::Value> {
    ...
    let p_a = args.first().cloned().unwrap_or(rt::Value::Undef);
    let p_b = args.get(1).cloned().unwrap_or(rt::Value::Undef);
    let out = rt::Value::Bool(is_def(fx, &[p_b.clone()])?.is_truthy() && rt::apply_binary(rt::BinOp::Eq, _list_pattern(fx, &[p_a.clone()])?, rt::apply_binary(rt::BinOp::Mul, p_b.clone(), rt::Value::Num(f64::from_bits(0x0_u64)))).is_truthy());
    Ok(out)
}
...
pub(super) fn is_consistent(fx: &dyn rt::FnCtx, args: &[rt::Value]) -> rt::Result<rt::Value> {
    ...
    let out = rt::Value::Bool(rt::bi::is_list(&[p_list.clone()]).is_truthy() && rt::Value::Bool(rt::apply_binary(rt::BinOp::Eq, rt::bi::len(&[p_list.clone()]), rt::Value::Num(f64::from_bits(0x0_u64))).is_truthy() || { let l0_pattern = if rt::bi::is_undef(&[p_pattern.clone()]).is_truthy() { _list_pattern(fx, &[rt::index(p_list.clone(), &rt::Value::Num(f64::from_bits(0x0_u64)))])? } else { _list_pattern(fx, &[p_pattern.clone()])? }; rt::apply_binary(rt::BinOp::Eq, rt::build_vector(vec![]), { let mut l1_acc: Vec<rt::Value> = Vec::new(); for l2_entry in rt::iter_values_native(&rt::apply_binary(rt::BinOp::Mul, rt::Value::Num(f64::from_bits(0x0_u64)), p_list.clone())) { if (rt::apply_binary(rt::BinOp::Ne, l2_entry.clone(), l0_pattern.clone())).is_truthy() { l1_acc.push(l2_entry.clone());
...
pub(super) fn _is_at_left(fx: &dyn rt::FnCtx, args: &[rt::Value]) -> rt::Result<rt::Value> {
    ...
    let p_eps = args.get(2).cloned().unwrap_or_else(|| rt::Value::Num(f64::from_bits(0x3e112e0be826d695_u64)));
    let out = rt::apply_binary(rt::BinOp::Le, _tri_class(fx, &[rt::build_vector(vec![p_pt.clone(), rt::index(p_line.clone(), &rt::Value::Num(f64::from_bits(0x0_u64))), rt::index(p_line.clone(), &rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64)))]), p_eps.clone()])?, rt::Value::Num(f64::from_bits(0x0_u64)));
    Ok(out)
}
...
pub(super) fn _sum(fx: &dyn rt::FnCtx, args: &[rt::Value]) -> rt::Result<rt::Value> {
    ...
    let out = if rt::apply_binary(rt::BinOp::Ge, p__i.clone(), rt::bi::len(&[p_v.clone()])).is_truthy() { p__total.clone() } else { _sum(fx, &[p_v.clone(), rt::apply_binary(rt::BinOp::Add, p__total.clone(), rt::index(p_v.clone(), &p__i.clone())), rt::apply_binary(rt::BinOp::Add, p__i.clone(), rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64)))])? };
    Ok(out)
}
...
pub(super) fn affine3d_zrot(fx: &dyn rt::FnCtx, args: &[rt::Value]) -> rt::Result<rt::Value> {
    ...
    let out = { if !(is_finite(fx, &[p_ang.clone()])?).is_truthy() { return Err(rt::assert_failed(None, "is_finite(ang)")); } rt::build_vector(vec![rt::build_vector(vec![rt::bi::cos(&[p_ang.clone()]), rt::apply_unary(rt::UnOp::Neg, rt::bi::sin(&[p_ang.clone()])), rt::Value::Num(f64::from_bits(0x0_u64)), rt::Value::Num(f64::from_bits(0x0_u64))]), rt::build_vector(vec![rt::bi::sin(&[p_ang.clone()]), rt::bi::cos(&[p_ang.clone()]), rt::Value::Num(f64::from_bits(0x0_u64)), rt::Value::Num(f64::from_bits(0x0_u64))]), rt::build_vector(vec![rt::Value::Num(f64::from_bits(0x0_u64)), rt::Value::Num(f64::from_bits(0x0_u64)), rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64)), rt::Value::Num(f64::from_bits(0x0_u64))]), rt::build_vector(vec![rt::Value::Num(f64::from_bits(0x0_u64)), rt::Value::Num(f64::from_bits(0x0_u64)), rt::Value::Num(f64::from_bits(0x0_u64)), rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64))])]) };
    Ok(out)
}
...
pub(super) fn affine3d_xrot(fx: &dyn rt::FnCtx, args: &[rt::Value]) -> rt::Result<rt::Value> {
    ...
    let p_ang = args.first().cloned().unwrap_or_else(|| rt::Value::Num(f64::from_bits(0x0_u64)));
    let out = { if !(is_finite(fx, &[p_ang.clone()])?).is_truthy() { return Err(rt::assert_failed(None, "is_finite(ang)")); } rt::build_vector(vec![rt::build_vector(vec![rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64)), rt::Value::Num(f64::from_bits(0x0_u64)), rt::Value::Num(f64::from_bits(0x0_u64)), rt::Value::Num(f64::from_bits(0x0_u64))]), rt::build_vector(vec![rt::Value::Num(f64::from_bits(0x0_u64)), rt::bi::cos(&[p_ang.clone()]), rt::apply_unary(rt::UnOp::Neg, rt::bi::sin(&[p_ang.clone()])), rt::Value::Num(f64::from_bits(0x0_u64))]), rt::build_vector(vec![rt::Value::Num(f64::from_bits(0x0_u64)), rt::bi::sin(&[p_ang.clone()]), rt::bi::cos(&[p_ang.clone()]), rt::Value::Num(f64::from_bits(0x0_u64))]), rt::build_vector(vec![rt::Value::Num(f64::from_bits(0x0_u64)), rt::Value::Num(f64::from_bits(0x0_u64)), rt::Value::Num(f64::from_bits(0x0_u64)), rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64))])]) };
    Ok(out)
}
...
pub(super) fn affine3d_yrot(fx: &dyn rt::FnCtx, args: &[rt::Value]) -> rt::Result<rt::Value> {
    ...
    let p_ang = args.first().cloned().unwrap_or_else(|| rt::Value::Num(f64::from_bits(0x0_u64)));
    let out = { if !(is_finite(fx, &[p_ang.clone()])?).is_truthy() { return Err(rt::assert_failed(None, "is_finite(ang)")); } rt::build_vector(vec![rt::build_vector(vec![rt::bi::cos(&[p_ang.clone()]), rt::Value::Num(f64::from_bits(0x0_u64)), rt::bi::sin(&[p_ang.clone()]), rt::Value::Num(f64::from_bits(0x0_u64))]), rt::build_vector(vec![rt::Value::Num(f64::from_bits(0x0_u64)), rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64)), rt::Value::Num(f64::from_bits(0x0_u64)), rt::Value::Num(f64::from_bits(0x0_u64))]), rt::build_vector(vec![rt::apply_unary(rt::UnOp::Neg, rt::bi::sin(&[p_ang.clone()])), rt::Value::Num(f64::from_bits(0x0_u64)), rt::bi::cos(&[p_ang.clone()]), rt::Value::Num(f64::from_bits(0x0_u64))]), rt::build_vector(vec![rt::Value::Num(f64::from_bits(0x0_u64)), rt::Value::Num(f64::from_bits(0x0_u64)), rt::Value::Num(f64::from_bits(0x0_u64)), rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64))])]) };
    Ok(out)
}
...
pub(super) fn in_list(fx: &dyn rt::FnCtx, args: &[rt::Value]) -> rt::Result<rt::Value> {
    ...
    let out = { if !(rt::bi::is_list(&[p_list.clone()])).is_truthy() { return Err(rt::assert_failed(Some(&rt::Value::string("Input is not a list")), "is_list(list)")); } { if !(rt::Value::Bool(rt::bi::is_undef(&[p_idx.clone()]).is_truthy() || is_finite(fx, &[p_idx.clone()])?.is_truthy())).is_truthy() { return Err(rt::assert_failed(Some(&rt::Value::string("Invalid idx value.")), "(is_undef(idx) || is_finite(idx))")); } { let l0_firsthit = rt::index(rt::bi::search(&[rt::build_vector(vec![p_val.clone()]), p_list.clone(), rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64)), p_idx.clone()]), &rt::Value::Num(f64::from_bits(0x0_u64))); if rt::apply_binary(rt::BinOp::Eq, l0_firsthit.clone(), rt::build_vector(vec![])).is_truthy() { rt::Value::Bool(false) } else { if rt::Value::Bool(rt::bi::is_undef(&[p_idx.clone()]).is_truthy() && rt::apply_binary(rt::BinOp::Eq, p_val.clone(), rt::index(p_list.clone(), &l0_firsthit.clone())).is_truthy()).is_truthy() { rt::Value::Bool(true) } else { if rt::Value::Bool(is_def(fx, &[p_idx.clone()])?.is_truthy() && rt::apply_binary(rt::BinOp::Eq, p_val.clone(), rt::index(rt::index(p_list.clone(), &l0_firsthit.clone()), &p_idx.clone())).is_truthy()).is_truthy() { rt::Value::Bool(true) } else { { let l1_allhits = rt::index(rt::bi::search(&[rt::build_vector(vec![p_val.clone()]), p_list.clone(), rt::Value::Num(f64::from_bits(0x0_u64)), p_idx.clone()]), &rt::Value::Num(f64::from_bits(0x0_u64))); if rt::bi::is_undef(&[p_idx.clone()]).is_truthy() { rt::apply_binary(rt::BinOp::Ne, { let mut l2_acc: Vec<rt::Value> = Vec::new(); for l3_hit in rt::iter_values_native(&l1_allhits.clone()) { if (rt::apply_binary(rt::BinOp::Eq, rt::index(p_list.clone(), &l3_hit.clone()), p_val.clone())).is_truthy() { l2_acc.push(rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64)));
...
pub(super) fn sum(fx: &dyn rt::FnCtx, args: &[rt::Value]) -> rt::Result<rt::Value> {
    ...
    let out = if rt::apply_binary(rt::BinOp::Eq, p_v.clone(), rt::build_vector(vec![])).is_truthy() { p_dflt.clone() } else { { if !(is_consistent(fx, &[p_v.clone()])?).is_truthy() { return Err(rt::assert_failed(Some(&rt::Value::string("\nInput to sum is non-numeric or inconsistent.")), "is_consistent(v)")); } if rt::Value::Bool(is_finite(fx, &[rt::index(p_v.clone(), &rt::Value::Num(f64::from_bits(0x0_u64)))])?.is_truthy() || is_vector(fx, &[rt::index(p_v.clone(), &rt::Value::Num(f64::from_bits(0x0_u64)))])?.is_truthy()).is_truthy() { rt::apply_binary(rt::BinOp::Mul, { let mut l0_acc: Vec<rt::Value> = Vec::new(); for l1_i in rt::iter_values_native(&p_v.clone()) { l0_acc.push(rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64)));
...
pub(super) fn unit(fx: &dyn rt::FnCtx, args: &[rt::Value]) -> rt::Result<rt::Value> {
    ...
    let out = { if !(is_vector(fx, &[p_v.clone()])?).is_truthy() { return Err(rt::assert_failed(Some(&rt::Value::string("\nInvalid vector.")), "is_vector(v)")); } if rt::apply_binary(rt::BinOp::Lt, rt::bi::norm(&[p_v.clone()]), rt::Value::Num(f64::from_bits(0x3e112e0be826d695_u64))).is_truthy() { if rt::apply_binary(rt::BinOp::Eq, p_error.clone(), rt::build_vector(vec![rt::build_vector(vec![rt::build_vector(vec![rt::Value::string("ASSERT")])])])).is_truthy() { { if !(rt::apply_binary(rt::BinOp::Ge, rt::bi::norm(&[p_v.clone()]), rt::Value::Num(f64::from_bits(0x3e112e0be826d695_u64)))).is_truthy() { return Err(rt::assert_failed(Some(&rt::Value::string("\nCannot normalize a zero vector.")), "(norm(v) >= _EPSILON)")); } rt::Value::Undef } } else { p_error.clone() } } else { rt::apply_binary(rt::BinOp::Div, p_v.clone(), rt::bi::norm(&[p_v.clone()])) } };
    Ok(out)
}
...
pub(super) fn select(fx: &dyn rt::FnCtx, args: &[rt::Value]) -> rt::Result<rt::Value> {
    ...
    let out = { if !(rt::Value::Bool(rt::bi::is_list(&[p_list.clone()]).is_truthy() || rt::bi::is_string(&[p_list.clone()]).is_truthy())).is_truthy() { return Err(rt::assert_failed(Some(&rt::Value::string("Invalid list.")), "(is_list(list) || is_string(list))")); } { let l0_l = rt::bi::len(&[p_list.clone()]); if rt::apply_binary(rt::BinOp::Eq, l0_l.clone(), rt::Value::Num(f64::from_bits(0x0_u64))).is_truthy() { rt::build_vector(vec![]) } else { if rt::apply_binary(rt::BinOp::Eq, p_end.clone(), rt::Value::Undef).is_truthy() { if rt::bi::is_num(&[p_start.clone()]).is_truthy() { rt::index(p_list.clone(), &rt::apply_binary(rt::BinOp::Mod, rt::apply_binary(rt::BinOp::Add, rt::apply_binary(rt::BinOp::Mod, p_start.clone(), l0_l.clone()), l0_l.clone()), l0_l.clone())) } else { { if !(rt::Value::Bool(rt::Value::Bool(rt::apply_binary(rt::BinOp::Eq, p_start.clone(), rt::build_vector(vec![])).is_truthy() || is_vector(fx, &[p_start.clone()])?.is_truthy()).is_truthy() || is_range(fx, &[p_start.clone()])?.is_truthy())).is_truthy() { return Err(rt::assert_failed(Some(&rt::Value::string("Invalid start parameter")), "(((start == []) || is_vector(start)) || is_range(start))")); } { let mut l1_acc: Vec<rt::Value> = Vec::new(); for l2_i in rt::iter_values_native(&p_start.clone()) { l1_acc.push(rt::index(p_list.clone(), &rt::apply_binary(rt::BinOp::Mod, rt::apply_binary(rt::BinOp::Add, rt::apply_binary(rt::BinOp::Mod, l2_i.clone(), l0_l.clone()), l0_l.clone()), l0_l.clone())));
        } rt::build_vector(l1_acc) } } } } else { { if !(is_finite(fx, &[p_start.clone()])?).is_truthy() { return Err(rt::assert_failed(Some(&rt::Value::string("When `end` is given, `start` parameter should be a number.")), "is_finite(start)")); } { if !(is_finite(fx, &[p_end.clone()])?).is_truthy() { return Err(rt::assert_failed(Some(&rt::Value::string("Invalid end parameter.")), "is_finite(end)")); } { let l3_s = rt::apply_binary(rt::BinOp::Mod, rt::apply_binary(rt::BinOp::Add, rt::apply_binary(rt::BinOp::Mod, p_start.clone(), l0_l.clone()), l0_l.clone()), l0_l.clone()); let l4_e = rt::apply_binary(rt::BinOp::Mod, rt::apply_binary(rt::BinOp::Add, rt::apply_binary(rt::BinOp::Mod, p_end.clone(), l0_l.clone()), l0_l.clone()), l0_l.clone()); if rt::apply_binary(rt::BinOp::Le, l3_s.clone(), l4_e.clone()).is_truthy() { { let mut l5_acc: Vec<rt::Value> = Vec::new(); for l6_i in rt::iter_values_native(&rt::build_range(&l3_s.clone(), &rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64)), &l4_e.clone())) { l5_acc.push(rt::index(p_list.clone(), &l6_i.clone()));
        } rt::build_vector(l5_acc) } } else { { let mut l7_acc: Vec<rt::Value> = Vec::new(); for l8_i in rt::iter_values_native(&rt::build_range(&l3_s.clone(), &rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64)), &rt::apply_binary(rt::BinOp::Sub, l0_l.clone(), rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64))))) { l7_acc.push(rt::index(p_list.clone(), &l8_i.clone()));
...
pub(super) fn _none_inside(fx: &dyn rt::FnCtx, args: &[rt::Value]) -> rt::Result<rt::Value> {
    ...
    let out = if rt::apply_binary(rt::BinOp::Ge, p_i.clone(), rt::bi::len(&[p_idxs.clone()])).is_truthy() { rt::Value::Bool(true) } else { { let l0_vert = rt::index(p_poly.clone(), &rt::index(p_idxs.clone(), &p_i.clone())); let l1_prev_vert = rt::index(p_poly.clone(), &select(fx, &[p_idxs.clone(), rt::apply_binary(rt::BinOp::Sub, p_i.clone(), rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64)))])?); let l2_next_vert = rt::index(p_poly.clone(), &select(fx, &[p_idxs.clone(), rt::apply_binary(rt::BinOp::Add, p_i.clone(), rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64)))])?); if rt::Value::Bool(rt::apply_binary(rt::BinOp::Le, _tri_class(fx, &[rt::build_vector(vec![l1_prev_vert.clone(), l0_vert.clone(), l2_next_vert.clone()]), p_eps.clone()])?, rt::Value::Num(f64::from_bits(0x0_u64))).is_truthy() && rt::Value::Bool(rt::Value::Bool(rt::Value::Bool(rt::apply_binary(rt::BinOp::Gt, _tri_class(fx, &[rt::build_vector(vec![p_p0.clone(), p_p1.clone(), l0_vert.clone()]), p_eps.clone()])?, rt::Value::Num(f64::from_bits(0x0_u64))).is_truthy() && rt::apply_binary(rt::BinOp::Gt, _tri_class(fx, &[rt::build_vector(vec![p_p1.clone(), p_p2.clone(), l0_vert.clone()]), p_eps.clone()])?, rt::Value::Num(f64::from_bits(0x0_u64))).is_truthy()).is_truthy() && rt::apply_binary(rt::BinOp::Ge, _tri_class(fx, &[rt::build_vector(vec![p_p2.clone(), p_p0.clone(), l0_vert.clone()]), p_eps.clone()])?, rt::Value::Num(f64::from_bits(0x0_u64))).is_truthy()).is_truthy() || rt::Value::Bool(rt::Value::Bool(rt::Value::Bool(rt::Value::Bool(rt::apply_binary(rt::BinOp::Lt, rt::bi::norm(&[rt::apply_binary(rt::BinOp::Sub, l0_vert.clone(), p_p1.clone())]), p_eps.clone()).is_truthy() && _is_at_left(fx, &[p_p0.clone(), rt::build_vector(vec![l1_prev_vert.clone(), p_p1.clone()]), p_eps.clone()])?.is_truthy()).is_truthy() && _is_at_left(fx, &[p_p2.clone(), rt::build_vector(vec![p_p1.clone(), l1_prev_vert.clone()]), p_eps.clone()])?.is_truthy()).is_truthy() && _is_at_left(fx, &[p_p2.clone(), rt::build_vector(vec![p_p1.clone(), l2_next_vert.clone()]), p_eps.clone()])?.is_truthy()).is_truthy() && _is_at_left(fx, &[p_p0.clone(), rt::build_vector(vec![l2_next_vert.clone(), p_p1.clone()]), p_eps.clone()])?.is_truthy()).is_truthy()).is_truthy()).is_truthy() { rt::Value::Bool(false) } else { _none_inside(fx, &[p_idxs.clone(), p_poly.clone(), p_p0.clone(), p_p1.clone(), p_p2.clone(), p_eps.clone(), rt::apply_binary(rt::BinOp::Add, p_i.clone(), rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64)))])? } } };
    Ok(out)
}
...
pub(super) fn _point_dist(fx: &dyn rt::FnCtx, args: &[rt::Value]) -> rt::Result<rt::Value> {
    ...
    let out = rt::bi::min(&[{ let mut l0_acc: Vec<rt::Value> = Vec::new(); for l1_i in rt::iter_values_native(&rt::build_range(&rt::Value::Num(f64::from_bits(0x0_u64)), &rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64)), &rt::apply_binary(rt::BinOp::Sub, rt::bi::len(&[p_pathseg_unit.clone()]), rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64))))) { { let l2_v = rt::apply_binary(rt::BinOp::Sub, p_pt.clone(), rt::index(p_path.clone(), &l1_i.clone())); let l3_projection = rt::apply_binary(rt::BinOp::Mul, l2_v.clone(), rt::index(p_pathseg_unit.clone(), &l1_i.clone())); let l4_segdist = if rt::apply_binary(rt::BinOp::Lt, l3_projection.clone(), rt::Value::Num(f64::from_bits(0x0_u64))).is_truthy() { rt::bi::norm(&[rt::apply_binary(rt::BinOp::Sub, p_pt.clone(), rt::index(p_path.clone(), &l1_i.clone()))]) } else { if rt::apply_binary(rt::BinOp::Gt, l3_projection.clone(), rt::index(p_pathseg_len.clone(), &l1_i.clone())).is_truthy() { rt::bi::norm(&[rt::apply_binary(rt::BinOp::Sub, p_pt.clone(), select(fx, &[p_path.clone(), rt::apply_binary(rt::BinOp::Add, l1_i.clone(), rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64)))])?)]) } else { rt::bi::norm(&[rt::apply_binary(rt::BinOp::Sub, l2_v.clone(), rt::apply_binary(rt::BinOp::Mul, l3_projection.clone(), rt::index(p_pathseg_unit.clone(), &l1_i.clone())))]) } }; l0_acc.push(l4_segdist.clone());
         } } rt::build_vector(l0_acc) }]);
    Ok(out)
}
...
pub(super) fn _get_ear(fx: &dyn rt::FnCtx, args: &[rt::Value]) -> rt::Result<rt::Value> {
    ...
    let out = { let l0_lind = rt::bi::len(&[p_ind.clone()]); if rt::apply_binary(rt::BinOp::Eq, l0_lind.clone(), rt::Value::Num(f64::from_bits(0x4008000000000000_u64))).is_truthy() { rt::Value::Num(f64::from_bits(0x0_u64)) } else { { let l1_p0 = rt::index(p_poly.clone(), &rt::index(p_ind.clone(), &p__i.clone())); let l2_p1 = rt::index(p_poly.clone(), &rt::index(p_ind.clone(), &rt::apply_binary(rt::BinOp::Mod, rt::apply_binary(rt::BinOp::Add, p__i.clone(), rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64))), l0_lind.clone()))); let l3_p2 = rt::index(p_poly.clone(), &rt::index(p_ind.clone(), &rt::apply_binary(rt::BinOp::Mod, rt::apply_binary(rt::BinOp::Add, p__i.clone(), rt::Value::Num(f64::from_bits(0x4000000000000000_u64))), l0_lind.clone()))); if rt::Value::Bool(rt::apply_binary(rt::BinOp::Gt, _tri_class(fx, &[rt::build_vector(vec![l1_p0.clone(), l2_p1.clone(), l3_p2.clone()]), p_eps.clone()])?, rt::Value::Num(f64::from_bits(0x0_u64))).is_truthy() && _none_inside(fx, &[select(fx, &[p_ind.clone(), rt::apply_binary(rt::BinOp::Add, p__i.clone(), rt::Value::Num(f64::from_bits(0x4000000000000000_u64))), p__i.clone()])?, p_poly.clone(), l1_p0.clone(), l2_p1.clone(), l3_p2.clone(), p_eps.clone()])?.is_truthy()).is_truthy() { p__i.clone() } else { if rt::apply_binary(rt::BinOp::Lt, p__i.clone(), rt::apply_binary(rt::BinOp::Sub, l0_lind.clone(), rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64)))).is_truthy() { _get_ear(fx, &[p_poly.clone(), p_ind.clone(), p_eps.clone(), rt::apply_binary(rt::BinOp::Add, p__i.clone(), rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64)))])? } else { { let l6_wiskers = { let mut l4_acc: Vec<rt::Value> = Vec::new(); for l5_j in rt::iter_values_native(&idx(fx, &[p_ind.clone()])?) { if (rt::apply_binary(rt::BinOp::Lt, rt::bi::norm(&[rt::apply_binary(rt::BinOp::Sub, rt::index(p_poly.clone(), &rt::index(p_ind.clone(), &l5_j.clone())), rt::index(p_poly.clone(), &rt::index(p_ind.clone(), &rt::apply_binary(rt::BinOp::Mod, rt::apply_binary(rt::BinOp::Add, l5_j.clone(), rt::Value::Num(f64::from_bits(0x4000000000000000_u64))), l0_lind.clone()))))]), p_eps.clone())).is_truthy() { l4_acc.push(l5_j.clone());
         } } rt::build_vector(l4_acc) }; if rt::apply_binary(rt::BinOp::Eq, l6_wiskers.clone(), rt::build_vector(vec![])).is_truthy() { rt::Value::Undef } else { rt::build_vector(vec![rt::index(l6_wiskers.clone(), &rt::Value::Num(f64::from_bits(0x0_u64)))]) } } } } } } };
    Ok(out)
}
...
pub(super) fn _vnf_centroid(fx: &dyn rt::FnCtx, args: &[rt::Value]) -> rt::Result<rt::Value> {
    ...
    let p_eps = args.get(1).cloned().unwrap_or_else(|| rt::Value::Num(f64::from_bits(0x3e112e0be826d695_u64)));
    let out = { if !(rt::Value::Bool(rt::Value::Bool(is_vnf(fx, &[p_vnf.clone()])?.is_truthy() && rt::apply_binary(rt::BinOp::Ne, rt::bi::len(&[rt::index(p_vnf.clone(), &rt::Value::Num(f64::from_bits(0x0_u64)))]), rt::Value::Num(f64::from_bits(0x0_u64))).is_truthy()).is_truthy() && rt::apply_binary(rt::BinOp::Ne, rt::bi::len(&[rt::index(p_vnf.clone(), &rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64)))]), rt::Value::Num(f64::from_bits(0x0_u64))).is_truthy())).is_truthy() { return Err(rt::assert_failed(Some(&rt::Value::string("\nInvalid or empty VNF given to centroid.")), "((is_vnf(vnf) && (len(vnf[0]) != 0)) && (len(vnf[1]) != 0))")); } { let l0_verts = rt::index(p_vnf.clone(), &rt::Value::Num(f64::from_bits(0x0_u64))); let l8_pos = sum(fx, &[{ let mut l1_acc: Vec<rt::Value> = Vec::new(); for l2_face in rt::iter_values_native(&rt::index(p_vnf.clone(), &rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64)))) { for l3_j in rt::iter_values_native(&rt::build_range(&rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64)), &rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64)), &rt::apply_binary(rt::BinOp::Sub, rt::bi::len(&[l2_face.clone()]), rt::Value::Num(f64::from_bits(0x4000000000000000_u64))))) { { let l4_v0 = rt::index(l0_verts.clone(), &rt::index(l2_face.clone(), &rt::Value::Num(f64::from_bits(0x0_u64)))); let l5_v1 = rt::index(l0_verts.clone(), &rt::index(l2_face.clone(), &l3_j.clone())); let l6_v2 = rt::index(l0_verts.clone(), &rt::index(l2_face.clone(), &rt::apply_binary(rt::BinOp::Add, l3_j.clone(), rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64))))); let l7_vol = rt::apply_binary(rt::BinOp::Mul, rt::bi::cross(&[l6_v2.clone(), l5_v1.clone()]), l4_v0.clone()); l1_acc.push(rt::build_vector(vec![l7_vol.clone(), rt::apply_binary(rt::BinOp::Mul, rt::apply_binary(rt::BinOp::Add, rt::apply_binary(rt::BinOp::Add, l4_v0.clone(), l5_v1.clone()), l6_v2.clone()), l7_vol.clone())]));
         } } } rt::build_vector(l1_acc) }])?; { if !(rt::apply_unary(rt::UnOp::Not, approx(fx, &[rt::index(l8_pos.clone(), &rt::Value::Num(f64::from_bits(0x0_u64))), rt::Value::Num(f64::from_bits(0x0_u64)), p_eps.clone()])?)).is_truthy() { return Err(rt::assert_failed(Some(&rt::Value::string("\nThe vnf has self-intersections.")), "(!approx(pos[0], 0, eps))")); } rt::apply_binary(rt::BinOp::Div, rt::apply_binary(rt::BinOp::Div, rt::index(l8_pos.clone(), &rt::Value::Num(f64::from_bits(0x3ff0000000000000_u64))), rt::index(l8_pos.clone(), &rt::Value::Num(f64::from_bits(0x0_u64)))), rt::Value::Num(f64::from_bits(0x4010000000000000_u64))) } } };
    Ok(out)
}
