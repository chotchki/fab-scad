...
fn m6_full_surface_golden() {
    ...
    let golden_table: &[(&str, u64)] = &[
        ...
        // M.7.3.1: 2D ingest snaps i_overlay's grid-shifted output back to EXACT input bits
        // (drill_guide axis-tunnel fix) — the non-dyadic-input cases regenerated, deliberate.
        ("cs_offset_square", 0x42417aae8cdee8bf),
        ("cs_offset_round", 0x021c38b86187412a),
        ("cs_offset_miter", 0xd916a0ad59daab8f),
        ("cs_offset_bevel", 0x999a13089597efc5),
        ("cs_hull", 0xed3e434bca18c641),
        ("cs_fill_rules", 0x3897291c7a7574b2),
